...
import 'package:tictoc/Constants/constants.dart';
import 'package:tictoc/Controllers/comments_controller.dart';

import 'package:tictoc/Controllers/video_controller.dart';
import 'package:tictoc/Custom%20Widgets/circle_animation.dart';
import 'package:tictoc/Custom%20Widgets/video_payer.dart';
import 'package:tictoc/Views/comments_screen.dart';
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    commentsController.getComment(videoController.videosList[index].id);
                                  },
                                  child: Column(
                                    children: [
                                      Icon(
